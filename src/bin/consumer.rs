...
struct Args {
    ...
    #[arg(
        ...
        default_value = "../certc_client/consumer.pem"
    )]
    fc_agent_client_cert: String,
    #[arg(
        long,
        env = "FC_AGENT_CLIENT_CERTIFICATE_KEY",
        default_value = "../certc_client/consumer-key.pem"
    )]
    fc_agent_client_cert_key: String,
    #[arg(long, env = "FC_BIND_ADDRESS", default_value = "0.0.0.0:8000")]
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    client_core::run_client_consumer(
